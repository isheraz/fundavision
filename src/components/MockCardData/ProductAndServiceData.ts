...
export const PRODUCTS_INFO : Array<ProductService> = [
    ...
    {  title:'Audio & Music', description:'Services Audio & Music',  starting_price:'450', ending_price:'740' } as ProductService ,
    {  title:'Web Development', description:'Services about',  starting_price:'230', ending_price:'340'  } as ProductService ,
];